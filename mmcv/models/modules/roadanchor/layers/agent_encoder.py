...
from .common_layers import build_mlp
from .embedding_agent import NATSequenceEncoder
...
class AgentEncoder(nn.Module):
    def __init__(
        ...
        self.type_emb = nn.Embedding(num_classes, dim)
    ...
    def forward(self, data):
        T = self.hist_steps # ours --> future steps
