...
class PlanningMetric():
    ...
    def get_birds_eye_view_label(
        ...
        # plt.savefig('/path/to/debug_figs/car_ped_occ.jpg')
        # plt.close()
    ...
    def evaluate_single_coll(self, traj, segmentation, input_gt):
        ...
        traj: torch.Tensor (n_future, 2)
            the ego lidar frame is the trajectory reference frame
                ^ y
                |
                | 
                0------->
        ...
        # convert the trajectory coordinate frame to:
        #  ^ x
        #  |
        #  | 
        #  0-------> y
        ...
        # if input_gt:
        #     plt.savefig('/path/to/debug_figs/occ_metric_stp3_gt.jpg')
        # else:
        #     plt.savefig('/path/to/debug_figs/occ_metric_stp3_pred.jpg')
        # plt.close()
    ...
    def evaluate_coll(
        ...
        for i in range(B):
            ...
            # project the trajectory from the lidar frame into image coordinates
