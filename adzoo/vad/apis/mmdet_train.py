...
def custom_train_detector(model,
                   ...
                   eval_model=None,
                   meta=None):
    # `log_level` is a level, not a path: passing it positionally landed it in
    # the `log_file` slot, so mmcv created a file literally named "INFO" in the
    # working directory and the iteration logs never reached work_dir. Reuse the
    # logger the entry point already configured instead.
